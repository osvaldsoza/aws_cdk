...
public class Service01Stack extends Stack {
    ...
    public Service01Stack(final Construct scope, final String id, final StackProps props, Cluster cluster) {
        ...
        ApplicationLoadBalancedFargateService service = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB01")
                .serviceName("service")
                .cluster(cluster)
                .cpu(512)
                .memoryLimitMiB(1024)
        ...
        scalableTaskCount.scaleOnCpuUtilization("ServiceAutoScaling", CpuUtilizationScalingProps.builder()
